    ...
    <div class="wrapper">
        <nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
            ...
            @if(count(config('panel.available_languages', [])) > 1)
                <ul class="navbar-nav ml-auto btn-primary rounded">
                    <li class="nav-item dropdown">
                        <a class="nav-link" data-toggle="dropdown" href="#" style="color: #ffffff !important;" >
        ...
        <footer class="main-footer">
            ...
            <strong> &copy;</strong> <a href="#">Majed Al Shuhoomi</a>  - {{ trans('global.allRightsReserved') }}
        </footer>
